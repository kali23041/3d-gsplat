...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center px-4 sm:px-6">
      {/* Background Effects */}
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-white/20 animate-fade-in-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-4 rounded-xl font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-200 hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
          ...
          <div className="mt-6 p-4 bg-white/5 rounded-xl border border-white/10">
            ...
            <p className="text-xs text-blue-200 text-center">Email: demo@gsplat.com</p>
            <p className="text-xs text-blue-200 text-center">Password: demo123</p>
          </div>
        </div>
